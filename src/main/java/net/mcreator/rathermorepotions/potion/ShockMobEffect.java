...
import net.mcreator.rathermorepotions.procedures.OnShockTriggeredProcedure;
...
public class ShockMobEffect extends MobEffect {
	...
	public String getDescriptionId() {
		return "effect.rather_more_potions.shock";
	}
	...
	public void applyInstantenousEffect(Entity source, Entity indirectSource, LivingEntity entity, int amplifier, double health) {
		OnShockTriggeredProcedure.execute(entity.level, entity.getX(), entity.getY(), entity.getZ());
	}
